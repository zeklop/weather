...
- **Динамический фавикон и App Badging:** отображение актуальной температуры на фавиконе вкладки браузера (Canvas API) и в виде системного бейджа на иконке рабочего стола (`navigator.setAppBadge` для iOS 16.4+ standalone / Android, опция включена по умолчанию в Настройках).
- **Улучшенный экран «Избранное»:** кнопка прямого поиска «Добавить город» в пустом состоянии и внизу списка избранного.
- **Блок авторства и версии в Настройках:** футер внизу `/settings/` с указанием авторства Zeklop (со ссылкой на GitHub) и датой версии сборки (`ГГГГ-ММ-ДД`).
